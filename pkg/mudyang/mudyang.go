...
type IETFMud_Mud_Transparency struct {
	...
	SbomLocalWellKnown	E_IETFMudTransparencyLocalType	`path:"sbom-local-well-known" module:"ietf-mud-transparency"`
...
// E_IETFMudTransparencyLocalType is a derived int64 type which is used to represent
// the enumerated node IETFMudTransparencyLocalType. An additional value named
// IETFMudTransparencyLocalType_UNSET is added to the enumeration which is used as
// the nil value, indicating that the enumeration was not explicitly set by
// the program importing the generated structures.
type E_IETFMudTransparencyLocalType int64

// IsYANGGoEnum ensures that IETFMudTransparencyLocalType implements the yang.GoEnum
// interface. This ensures that IETFMudTransparencyLocalType can be identified as a
// mapped type for a YANG enumeration.
func (E_IETFMudTransparencyLocalType) IsYANGGoEnum() {}

// ΛMap returns the value lookup map associated with  IETFMudTransparencyLocalType.
func (E_IETFMudTransparencyLocalType) ΛMap() map[string]map[int64]ygot.EnumDefinition { return ΛEnum; }

// String returns a logging-friendly string for E_IETFMudTransparencyLocalType.
func (e E_IETFMudTransparencyLocalType) String() string {
	return ygot.EnumLogString(e, int64(e), "E_IETFMudTransparencyLocalType")
}

const (
	// IETFMudTransparencyLocalType_UNSET corresponds to the value UNSET of IETFMudTransparencyLocalType
	IETFMudTransparencyLocalType_UNSET E_IETFMudTransparencyLocalType = 0
	// IETFMudTransparencyLocalType_coap corresponds to the value coap of IETFMudTransparencyLocalType
	IETFMudTransparencyLocalType_coap E_IETFMudTransparencyLocalType = 1
	// IETFMudTransparencyLocalType_coaps corresponds to the value coaps of IETFMudTransparencyLocalType
	IETFMudTransparencyLocalType_coaps E_IETFMudTransparencyLocalType = 2
	// IETFMudTransparencyLocalType_http corresponds to the value http of IETFMudTransparencyLocalType
	IETFMudTransparencyLocalType_http E_IETFMudTransparencyLocalType = 3
	// IETFMudTransparencyLocalType_https corresponds to the value https of IETFMudTransparencyLocalType
	IETFMudTransparencyLocalType_https E_IETFMudTransparencyLocalType = 4
)
...
var ΛEnum = map[string]map[int64]ygot.EnumDefinition{
	...
	"E_IETFMudTransparencyLocalType": {
...
func initΛEnumTypes(){
  ΛEnumTypes = map[string][]reflect.Type{
	...
	"/mud/transparency/sbom-local-well-known": []reflect.Type{
		reflect.TypeOf((E_IETFMudTransparencyLocalType)(0)),
	},
